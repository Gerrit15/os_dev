...
print_hex:
  ...
  hex_loop:
    ...
    hex_mv_to_bx:
      add al, 0x30         ; this works because the hex range is at least 30 below the actual ascii values, but the capitals are offset by 7 from the numbers in ascii
    mov bx, hex_string + 5 ; base address of string + string len
    sub bx, cx             ; subtract iterator value
    inc cx                 ; if it fucks up, this is the issue
